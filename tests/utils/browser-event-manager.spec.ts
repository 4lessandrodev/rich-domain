...
describe("BrowserEventManager", () => {
  ...
  describe("instance", () => {
    it("should throw if window is not defined", () => {
      const init = () =>
        BrowserEventManager.instance(undefined as unknown as any);
      expect(init).toThrow();
    });
  ...
  describe("subscribe", () => {
    it("should subscribe to an event", () => {
      ...
      expect(unload).toHaveBeenLastCalledWith(
        "beforeunload",
        expect.any(Function),
      );
  ...
  describe("removeEvent", () => {
    it("should remove a subscribed event", () => {
      ...
      instance.subscribe(eventName, callback);
      expect(instance.exists(eventName)).toBeTruthy();
      instance.removeEvent(eventName);
      expect(
        globalThis.window.sessionStorage.getItem(
          `rich-domain-event:${eventName}`,
        ),
  ...
  it("should remove event", () => {
    ...
    const removed = instance.removeEvent("test:event");
  ...
  it("should do not remove event", () => {
    ...
    const removed = instance.removeEvent("invalid:event");
